...
class CommonPlatform ():
    PackagesSupported = ("hebePkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('hebe', 'gcc_aarch64_linux', 'edk2-build')
    ...
    PackagesPath = (
        ...
        "Silicon/Silicium",
        "Silicium-ACPI",
        #"Silicium-ACPI/Platforms/Huawei",
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "hebe", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "hebePkg/hebe.dsc", "Platform Hardcoded")
