...
class CommonPlatform ():
    PackagesSupported = ("r0sPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('r0s', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "r0s", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "r0sPkg/r0s.dsc", "Platform Hardcoded")
