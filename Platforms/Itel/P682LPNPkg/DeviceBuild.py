...
class CommonPlatform ():
    PackagesSupported = ("P682LPNPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('P682LPN', 'gcc_aarch64_linux', 'edk2-build')
    ...
    PackagesPath = (
        ...
        "Silicon/Unisoc",
        "Silicon/Silicium"#,
        #"Silicium-ACPI/Platforms/Itel",
        #"Silicium-ACPI/SoCs/Unisoc"
    )
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "P682LPN", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "P682LPNPkg/P682LPN.dsc", "Platform Hardcoded")
